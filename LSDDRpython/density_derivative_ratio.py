...
class DensityDerivativeRatio:
    """Density Derivative Ratio."""
    def __init__(self, method, theta, lambda_, kernel_info, compute_density_deriv_ratio):
        self.method = method
        self.theta = theta
        self.lambda_ = lambda_
        self.kernel_info = kernel_info
        self.compute_density_deriv_ratio = compute_density_deriv_ratio
